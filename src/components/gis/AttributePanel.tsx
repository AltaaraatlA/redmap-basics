...
export function AttributePanel() {
  ...
  return (
    <Tabs defaultValue="features" className="flex h-full flex-col">
      ...
      <TabsContent value="features" className="flex-1 overflow-hidden data-[state=inactive]:hidden">
        {f ? (
          <div className="flex h-full flex-col">
            <div className="flex items-center gap-2 border-b border-border bg-card px-4 py-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-md bg-primary text-primary-foreground">
                <typeIcon key={f.type} className="h-4 w-4" />
              </div>
  ...
  {JSON.stringify(f.geojson.geometry, null, 2)}
      ...
      <TabsContent value="database" className="flex-1 overflow-hidden data-[state=inactive]:hidden">
        <div className="flex h-full flex-col items-center justify-center p-6 text-center text-sm text-muted-foreground">
